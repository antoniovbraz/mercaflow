...
export const MLUserDataSchema = z.object({
  ...
  registration_date: z.string().optional(), // ML returns with timezone offset (-04:00), not just Z
...
export const MLOrderShippingSchema = z.object({
  ...
  status_history: z.object({
    date_shipped: z.string().nullable().optional(),
    date_delivered: z.string().nullable().optional(),
    date_first_visit: z.string().nullable().optional(),
    date_not_delivered: z.string().nullable().optional(),
    date_cancelled: z.string().nullable().optional(),
    date_handling: z.string().nullable().optional(),
    date_ready_to_ship: z.string().nullable().optional(),
  }).optional(),
  date_created: z.string().optional(),
  last_updated: z.string().optional(),
...
export const OrdersSearchQuerySchema = z.object({
  ...
  'order.date_created.from': z.string().optional(),
  'order.date_created.to': z.string().optional(),
});
