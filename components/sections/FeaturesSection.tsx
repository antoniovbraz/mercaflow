  ...
  const features = [
    {
      ...
      description:
        'Elasticidade-preço da demanda, ponto de equilíbrio otimizado e curva de demanda. Não é "feeling" - é economia aplicada dizendo seu preço ótimo.',
      benefits: [
    ...
    },
    {
      ...
      description:
        "IA prevê suas vendas nos próximos 30/60/90 dias com 87% de precisão. Sazonalidade, tendências e recomendações de estoque baseadas em dados reais.",
      benefits: [
    ...
    },
    {
      ...
      description:
        'Não mostramos só gráficos - dizemos EXATAMENTE o que fazer. "Aumente preço 8%" ou "Otimize este título". Dashboard ativo, não passivo.',
      benefits: [
    ...
    },
    {
      ...
      description:
        "Monitore concorrentes 24/7. Alertas automáticos de mudanças de preço, benchmarking e estratégias sugeridas para se destacar.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Crie site profissional em < 15 minutos. Sincronização automática com marketplaces, SEO otimizado e zero código necessário.",
    ...
    },
    {
      ...
      description:
        "NLP otimiza títulos e descrições automaticamente. Análise de sentiment de reviews e sugestões de categorias mais assertivas.",
      benefits: [
  ...
  const highlights = [
    {
      ...
      description:
        "Hoje Mercado Livre. Em breve: Shopee, Amazon BR, Magazine Luiza. Catálogo unificado inteligente.",
    },
    {
      icon: Shield,
      title: "Segurança Enterprise",
      description:
        "Criptografia AES-256-GCM, multi-tenancy com RLS, LGPD compliant e auditoria completa.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <strong>insights acionáveis</strong>. Dashboards ativos que sugerem
            ações concretas, não apenas mostram números.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`relative inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300`}
              >
              ...
              <div className="relative">
                ...
                <ul className="space-y-2 mb-6">
                  {feature.benefits.map((benefit, i) => (
                    ...
                    >
                      <div
                        className={`w-1.5 h-1.5 bg-gradient-to-r ${feature.gradient} rounded-full`}
                      />
                      <span>{benefit}</span>
                    </li>
                  ))}
