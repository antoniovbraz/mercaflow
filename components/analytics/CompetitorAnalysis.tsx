  ...
  useEffect(() => {
    const fetchCompetitorData = async () => {
      try {
        ...
        const url = `/api/analytics/competitors${
          productId ? `?item_id=${productId}&limit=10` : "?limit=10"
        }`;
          ...
          for (const competitor of productAnalysis.competitors || []) {
            transformedCompetitors.push({
              ...
              name:
                ...
                " - " +
                competitor.title.substring(0, 30),
              rank: rank++,
              ...
              reviews: 0, // Mock
              reputation:
                competitor.positioning === "cheaper"
                  ? "budget"
                  : competitor.positioning === "expensive"
                  ? "premium"
                  : "mid-range",
        ...
        const finalCompetitors =
          mockCompetitors.length > 1 ? mockCompetitors : transformedCompetitors;
