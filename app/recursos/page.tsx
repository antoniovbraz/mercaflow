  ...
  const mainFeatures = [
    {
      ...
      description:
        'Não é "feeling" ou copiar concorrente. Usamos economia aplicada para calcular seu preço ótimo baseado em elasticidade da demanda, ponto de equilíbrio e curva de oferta/demanda.',
      features: [
    ...
    },
    {
      ...
      description:
        "IA prevê suas vendas nos próximos 30/60/90 dias usando modelos de séries temporais, sazonalidade e tendências. Recomendações automáticas de estoque baseadas em previsões.",
      features: [
      ...
      example:
        'Exemplo: "Próximos 30 dias: 234 vendas (±15%) | Confiança: 87%"',
    },
    {
      icon: Brain,
      title: "Insights Acionáveis - Dashboard Ativo",
      description:
        "Não mostramos só gráficos. Dizemos EXATAMENTE o que fazer, quando fazer e qual o impacto esperado. Dashboard ativo com cards de oportunidades priorizados por ROI.",
      features: [
    ...
    },
    {
      ...
      description:
        "Monitore concorrentes automaticamente. Alertas em tempo real de mudanças de preço, benchmarking por categoria e estratégias sugeridas para se destacar.",
      features: [
      ...
      example:
        'Exemplo: "⚠️ Concorrente: R$ 129 | Você: R$ 159 | Ação sugerida"',
    },
    {
      icon: Sparkles,
      title: "Site Automático Sincronizado",
      description:
        "Crie site profissional em < 15 minutos. Zero código necessário. Sincronização automática com Mercado Livre via webhooks. SEO otimizado e domínio personalizado.",
      features: [
    ...
    },
    {
      ...
      description:
        "Processamento de linguagem natural (NLP) para otimizar títulos, descrições e categorias. Análise de sentiment de reviews para identificar pontos fortes/fracos.",
      features: [
      ...
      example:
        "Exemplo: \"Título fraco detectado → IA sugere: 'Tênis Nike...'\"",
    },
  ];
  ...
  const additionalFeatures = [
    {
      ...
      description:
        "Hoje Mercado Livre. Em breve: Shopee, Amazon BR, Magazine Luiza. Catálogo unificado com análise cross-platform.",
    ...
    },
    {
      ...
      description:
        "Criptografia AES-256-GCM, multi-tenancy com RLS, LGPD compliant e auditoria completa de ações.",
      gradient: "from-orange-500 to-red-500",
    },
    {
      icon: Zap,
      ...
      description:
        "Atualizações em tempo real via webhooks. API RESTful completa para integrações customizadas.",
      gradient: "from-purple-500 to-violet-500",
    },
  ];
          ...
          <div className="text-center">
            <div className="inline-flex items-center space-x-2 bg-blue-100 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium text-blue-800">
                Inteligência Analítica + Automação
              </span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Economia aplicada + IA + análise preditiva. Não mostramos apenas
              gráficos - dizemos exatamente{" "}
              <strong>
                o que fazer, quando fazer e qual o impacto esperado
              </strong>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Decisões baseadas em economia, ciência de dados e IA - não em
              achismo
            </p>
          </div>
            ...
            {mainFeatures.map((feature, index) => (
              ...
              >
                ...
                <div className={index % 2 === 1 ? "lg:col-start-2" : ""}>
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl mb-6`}
                  >
                ...
                <div className={index % 2 === 1 ? "lg:col-start-1" : ""}>
                  <div
                    className={`bg-gradient-to-br ${feature.gradient} rounded-2xl p-8 h-80 flex items-center justify-center`}
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {additionalFeatures.map((feature, index) => (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br ${feature.gradient} rounded-xl mb-6`}
                >
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Mais de 2.500 vendedores transformaram dashboards passivos em
            insights acionáveis. 87% de precisão preditiva. ROI médio de{" "}
            <strong>+R$ 15k/mês</strong>. Teste grátis por 14 dias - sem cartão,
            sem compromisso.
          </p>
