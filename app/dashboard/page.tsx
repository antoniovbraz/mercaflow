              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Conecte sua conta, sincronize produtos e gerencie vendas de forma centralizada
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm overflow-hidden shadow-lg rounded-xl border border-gray-100/50 hover:shadow-xl transition-all duration-300">
            <div className="p-4">
              <div className="flex items-center mb-3">
                ...
                <h4 className="ml-3 font-semibold text-gray-900 text-sm">Clientes</h4>
              </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm overflow-hidden shadow-lg rounded-xl border border-gray-100/50 hover:shadow-xl transition-all duration-300">
            <div className="p-4">
              <div className="flex items-center mb-3">
                ...
                <h4 className="ml-3 font-semibold text-gray-900 text-sm">Estoque</h4>
              </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm overflow-hidden shadow-lg rounded-xl border border-gray-100/50 hover:shadow-xl transition-all duration-300">
            <div className="p-4">
              <div className="flex items-center mb-3">
                ...
                <h4 className="ml-3 font-semibold text-gray-900 text-sm">Configurações</h4>
              </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="text-2xl font-bold text-gray-900">Painel Super Admin</h3>
                        <span className="px-3 py-1 bg-red-100 text-red-800 text-xs font-bold rounded-full animate-pulse">
                          ADMIN SYSTEM
                        </span>
                      </div>
                      <p className="text-gray-600 text-lg">
                        Controle total do sistema, usuários, integrações e configurações avançadas
                      </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    <dt className="text-sm font-medium text-gray-500 mb-1">Nível de Acesso</dt>
                    <dd>
                  ...
                  <div>
                    <dt className="text-sm font-medium text-gray-500 mb-1">Membro desde</dt>
                ...
                <div className="space-y-4">
                  <div>
                    <dt className="text-sm font-medium text-gray-500 mb-1">ID do Usuário</dt>
                  ...
                  <div>
                    <dt className="text-sm font-medium text-gray-500 mb-1">Status da Conta</dt>
                    <dd className="flex items-center space-x-2">
                  ...
                  <div>
                    <dt className="text-sm font-medium text-gray-500 mb-1">Plano</dt>
                    <dd>
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full flex items-center justify-between p-3 text-left rounded-xl hover:bg-gray-50 transition-colors group">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium text-gray-700">Verificar Email</span>
                  </div>
                  <svg className="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                  </svg>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200/50 shadow-lg rounded-2xl p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Suporte</h4>
