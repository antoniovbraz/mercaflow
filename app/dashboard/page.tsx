            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-green-800">
                  Conexão com MercadoLibre realizada com sucesso!
                </h3>
                <div className="mt-2 text-sm text-green-700">
                  <p>Agora você pode monitorar seus produtos e concorrentes.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">
                Bem-vindo ao Merca Flow! 🚀
              </h2>
              <p className="text-gray-600 mb-4">
                Sua conta MercadoLibre foi conectada com sucesso. Agora você pode começar a monitorar seus produtos e analisar a concorrência.
              </p>
          ...
          <div className="bg-white overflow-hidden shadow-sm rounded-lg hover:shadow-md transition-shadow cursor-pointer">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">Ver Relatórios</h3>
            ...
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">Alertas e notificações</p>
                </div>
              </div>
            </div>
          </div>
